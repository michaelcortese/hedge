...
_STATION_LIST: list[Station] = [
    ...
    Station("KXHIGHCHI", "Chicago", "KMDW", 41.79, -87.75, "America/Chicago"),
    Station("KXHIGHMIA", "Miami", "KMIA", 25.79, -80.29, "America/New_York"),
    Station("KXHIGHAUS", "Austin", "KAUS", 30.19, -97.67, "America/Chicago"),
]
